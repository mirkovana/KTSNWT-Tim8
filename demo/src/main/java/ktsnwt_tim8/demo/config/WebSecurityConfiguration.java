package ktsnwt_tim8.demo.config;
...
import ktsnwt_tim8.demo.security.auth.RestAuthenticationEntryPoint;
import ktsnwt_tim8.demo.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests().antMatchers("/auth/**", "/api/comments/**", "/api/ratings/**", "/api/Offer-images/**", "/api/offers/filter/**", "/api/offers/**",
                		"/api/categories/**", "/api/subcategories/**", "/api/posts/**").permitAll()
